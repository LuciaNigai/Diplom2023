...
public class AnimalsFragment extends Fragment {
    ...
    List<Item> items_animals = new ArrayList<Item>();
    MyPostAdapterCLass adapter_animals;
    RecyclerView recyclerView_animals;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView_animals = view.findViewById(R.id.recycler_view_posts_animals);

        ///--------------------------------get data from the database------------------------------------------------------
        adapter_animals = new MyPostAdapterCLass(getActivity(), items_animals);
        recyclerView_animals.setLayoutManager(new LinearLayoutManager(getActivity()));
        recyclerView_animals.setAdapter(new MyPostAdapterCLass(getActivity().getApplicationContext(), items_animals));
        loadProducts();
        ...
        buttonAddPost = view.findViewById(R.id.add_post_button_animals);
    ...
    private void loadProducts(){
        StringRequest stringRequest = new StringRequest(Request.Method.GET, Url_http.getURL()+"login-registration-android/post_animals_get.php", new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                try {
                    ...
                    adapter_animals = new MyPostAdapterCLass(getActivity(), items_animals);
                    recyclerView_animals.setAdapter(adapter_animals);

                    //sorting the posts by the date, the newest on the top
                    Collections.sort(items_animals, new Comparator<Item>() {
                        @Override
