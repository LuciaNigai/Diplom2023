...
public class ChangeUserEmailFragment extends Fragment {
    ...
    TextInputEditText textInputEditTextChangeEmail;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        textInputEditTextChangeEmail=(TextInputEditText) getActivity().findViewById(R.id.change_email);
            ...
            public void onResponse(String response) {
                try {
                    ...
                    for(int i=0; i<itemsJsonArray.length(); i++){
                        ...
                        textInputEditTextChangeEmail.setText(email);
                    }
        ...
        buttonCancel=view.findViewById(R.id.change_email_cancel);
        ...
        buttonOK=view.findViewById(R.id.change_email_OK);
        AlertDialog.Builder builder;
        builder= new AlertDialog.Builder(getActivity());
        buttonOK.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                builder.setTitle("Email change confirmation");
                builder.setMessage("Are you sure you want to change your email?");
                builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        String changedEmail =textInputEditTextChangeEmail.getText().toString();
                        RequestQueue queue = Volley.newRequestQueue(getActivity().getApplicationContext());
                        StringRequest stringRequest = new StringRequest(Request.Method.POST, url + "login-registration-android/change_useremail.php",
                                new Response.Listener<String>() {
                                    ...
                                    public void onResponse(String response) {
                                        ...
                                        else Toast.makeText(getActivity().getApplicationContext(), "This email already exists, please enter another email", Toast.LENGTH_SHORT).show();
                                    }
                                }, new Response.ErrorListener() {
                            @Override
                            public void onErrorResponse(VolleyError error) {
