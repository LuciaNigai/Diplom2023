...
public class ChildrenFragment extends Fragment {
    ...
    List<Item> items_children = new ArrayList<Item>();
    MyPostAdapterCLass adapter_children;
    RecyclerView recyclerView_children;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView_children = view.findViewById(R.id.recycler_view_posts_children);

        ///--------------------------------get data from the database------------------------------------------------------
        adapter_children = new MyPostAdapterCLass(getActivity(), items_children);
        recyclerView_children.setLayoutManager(new LinearLayoutManager(getActivity()));
        recyclerView_children.setAdapter(new MyPostAdapterCLass(getActivity().getApplicationContext(), items_children));
        loadProducts();
        ...
        buttonAddPost = view.findViewById(R.id.add_post_button_children);
    ...
    private void loadProducts(){
        StringRequest stringRequest = new StringRequest(Request.Method.GET, Url_http.getURL()+"login-registration-android/post_children_get.php", new Response.Listener<String>() {
            @Override
