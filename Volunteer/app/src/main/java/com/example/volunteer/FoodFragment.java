...
public class FoodFragment extends Fragment {
    ...
    List<Item> items_food = new ArrayList<Item>();
    MyPostAdapterCLass adapter_food;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
     ...
     public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
         ...
         recyclerView_food = view.findViewById(R.id.recycler_view_posts_food);

         ///--------------------------------get data from the database------------------------------------------------------
         adapter_food = new MyPostAdapterCLass(getActivity(),items_food);
         recyclerView_food.setLayoutManager(new LinearLayoutManager(getActivity()));
         recyclerView_food.setAdapter(new MyPostAdapterCLass(getActivity().getApplicationContext(),items_food));
         loadProducts();
         ...
         buttonAddPost = view.findViewById(R.id.add_post_button_food);
    ...
    private void loadProducts(){
        StringRequest stringRequest = new StringRequest(Request.Method.GET, Url_http.getURL()+"login-registration-android/post_food_get.php", new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                try {
                    ...
                    Collections.sort(items_food, new Comparator<Item>() {
                        @Override
